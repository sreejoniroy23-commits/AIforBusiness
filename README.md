...
### 1️⃣ Data cleaning & exploratory analysis
...
### 2️⃣ Supervised modelling (main analysis)
**Notebook:** `Notebook2_modelling_Jan4.ipynb`

This is the **core modelling notebook** and main focus for grading.
...
### 3️⃣ Clustering & BERTopic (unsupervised insights)
...
These files support reproducibility of different modelling pipelines.
...
3. (Optional) Run `Clustering+BERTopic.ipynb`
